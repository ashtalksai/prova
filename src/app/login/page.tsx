      ...
      <div className="flex items-center justify-center bg-[#0a0e1a] p-8 min-h-screen">
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-[#c9a84c] text-xs hover:text-[#d4b85c] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-[#a0a8b8]">
            ...
            <Link href="/signup" className="text-[#c9a84c] hover:text-[#d4b85c] transition-colors">
              Start free trial
            </Link>
          </p>
